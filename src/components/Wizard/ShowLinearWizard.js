...
const ShowLinearWizard = () => {
  ...
  else
  {
    return (  
        ...
        <div>
          <Wizard cancelDeletion={() => clearState()} onSaveClicked={() => saveFunction()} onSubmitClicked={((selected2&&(selected&&(treetyp != 0))) ? "true" : "false")} submitFunctionDefined={() => submitFunction()}>
...
export default ShowLinearWizard;
