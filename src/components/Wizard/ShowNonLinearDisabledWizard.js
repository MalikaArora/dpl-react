...
const ShowNonLinearDisabledWizard = () => {
  ...
  else
  {
    return (  
        ...
        <div>
          <Wizard cancelDeletion={() => clearState()} onSaveClicked={() => saveFunction()} onSubmitClicked={((selected2&&selected) ? "true" : "false")} submitFunctionDefined={() => submitFunction()} nonlinear="true">
...
export default ShowNonLinearDisabledWizard;